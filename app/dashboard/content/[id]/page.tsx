...
export default async function ContentDetailPage({ params }: ContentDetailPageProps) {
  ...
  // Check if media URLs are present
    ...
    <div className="fade-up">
      ...
      <div className="page-header" style={{ marginBottom: '1.5rem' }}>
        ...
        <div className="page-actions" style={{ display: 'flex', gap: '0.75rem' }}>
          <Link href="/dashboard/content" className="btn btn-secondary">
            Back to List
          </Link>
          {(roles.isAdmin || roles.isCreater) && content.st !== 2 && (
            <Link href={`/dashboard/content/${id}/edit`} className="btn btn-primary">
          ...
          <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            {(roles.isAdmin || roles.isPublisher) && (
              <div style={{ borderTop: '1px solid var(--border-subtle)', paddingTop: '1rem', marginTop: '0.25rem' }}>
                ...
                <ContentActions content={content} isPublisher={roles.isAdmin || roles.isPublisher} />
              </div>
            )}
          </div>
